...
import com.buzzyog.snippets.utils.ReflectionUtils;

public class BossBarAPIV2
{
	private static BossBarAPIV2 instance;
	private Map< String , Dragon > dragonMap = new HashMap< String , Dragon >();
	
	private BossBarAPIV2()
	{
	}
	
	public static BossBarAPIV2 getInstance()
	{
		if ( BossBarAPIV2.instance == null )
			BossBarAPIV2.instance = new BossBarAPIV2();
		
		return BossBarAPIV2.instance;
	}
